...
variable "single_intra_route_table" {
  description = "Controls if a single route table is created for intra subnets, or one per subnet"
  type        = bool
  default     = true
}

variable "single_public_route_table" {
  description = "Controls if a single route table is created for public subnets, or one per subnet"
  type        = bool
  default     = true
}
