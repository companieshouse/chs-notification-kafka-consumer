...
# ------------------------------------------------------------------------------
# Optional additional side car variables
# ------------------------------------------------------------------------------
variable "additional_sidecar_containers" {
  type = list(object({
    name   = string
    image  = string
    memory = number
    ...
    depends_on = optional(list(object({
      ...
      condition      = optional(string, "START")
    })), [])
  ...
  description = "List of additional sidecar containers to add to task definition"
  default     = []
}

variable "ecs_cluster_name" {
  type        = string
  description = "The name of the ecs cluster where this is different to '$${var.name_prefix}-cluster'"
  default     = ""
}
