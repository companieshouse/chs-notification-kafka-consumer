...
variable "license_type" {
  ...
  description = "The type of license to use. For single instance: ['capacity-paygo']. For HA: ['ha-capacity-paygo']."
  validation {
    condition     = contains(["capacity-paygo", "ha-capacity-paygo"], var.license_type)
    error_message = "Provided licence type is not valid. Should be one of ['capacity-paygo'] for single instance or ['ha-capacity-paygo'] for HA."
  }
}
...
variable "capacity_package_name" {
  ...
  validation {
    condition     = contains(["Essential", "Professional", "Freemium"], var.capacity_package_name)
    error_message = "Provided capacity package name is not valid. Should be one of Essential, Professional or Freemium."
  }
}
