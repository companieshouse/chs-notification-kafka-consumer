resource "aws_ecs_service" "ecs-service" {
  ...
  dynamic "load_balancer" {
    ...
    content {
      ...
      container_name   = var.use_eric_reverse_proxy ? "eric" : var.service_name
    }
  }
...
resource "aws_ecs_task_definition" "ecs-task-definition" {
  ...
  cpu                      = var.use_eric_reverse_proxy ? var.required_cpus + var.eric_cpus : var.required_cpus
  memory                   = var.use_eric_reverse_proxy ? var.required_memory + var.eric_memory : var.required_memory
