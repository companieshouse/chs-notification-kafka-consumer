# grafana-cross-account-access-role

> This project was generated by [generator-tf-module](https://github.com/sudokar/generator-tf-module)

## Overview

Creates a role for AWS Managed Grafana to use to access data sources.

## Usage

```hcl
module "grafana-cross-account-access-role" {
  source = "git@github.com:companieshouse/terraform-modules//aws/grafana-cross-account-access-role"
  
  grafana_account = "111111111111"
}
```
